...
const experiences = [
  {
    ...
    companyEn: "HeadPoint",
    logo: "/HP.png",
    role: "Руководитель продукта / Project Manager",
    ...
    descriptionRu: `HeadPoint - Руководитель продукта / Project Manager

Проект: ГИС ЕЦХД (государственная информационная система “Единый центр хранения и обработки данных”)

В зоне ответственности:

Ведение полного цикла работ: сбор/уточнение требований, оценка, планирование, постановка задач, контроль исполнения, релизы в прод.

Управление кросс-функциональной командой 25+ человек (разработка, тестирование, аналитика, DevOps, СТП).

Коммуникации с заказчиком: регулярные статусы, фиксация договорённостей, управление сроками, ожиданиями и рисками.

Подготовка технической/тендерной/проектно-сметной документации: СТ, ТЗ, API, архитектура, ПМИ, руководства, ЧТЗ, НМЦК, паспорт проекта.

Результаты:

Перестроил процесс релизов: внедрил 2-недельные спринты и план-график релизов на 12 месяцев.

Закрыл накопленный техдолг (800+ часов) без просадки по новым контрактам за счёт перестройки процессов разработки и релизов.

Наладил end-to-end флоу: от получения требований до вывода инициатив в прод.

GenAI/AI-инициативы для оптимизации процессов и аналитики:

Внедрил AI-контур для автоматической классификации инцидентов по типам/приоритетам и автозаведения тикетов, настроил распознавание скриншотов от заказчика с выделением и интерпретацией сообщений об ошибках.

Внедрил GenAI для подготовки релизного пакета: релизная документация, аналитические записки, планы работ и протоколы внутренней приёмки на основе данных из трекера задач/релиз-плана/результатов проверок.

Запустил AI-поддержку аналитики и автоматизации ряда операционных процессов по данным из БД по камерам (более 400 000 штук, пользователям, правам, квотам, расписаниям, скриншотам с камер.  снизил долю ручной обработки и ускорил разбор нестандартных кейсов за счёт связки SQL-аналитики и AI-обработки материалов.`,
...
-Вёл B2B-направление, проводил пресейлы и общение с партнёрами, согласовывал условия, подписывал контракты, запускал интеграции и совместные сценарии.

-Параллельно контролировал delivery: координировал команду (разработка/дизайн/маркетинг/девопс), сроки и релизы также были на моих плечах.

-Перезапустил вместе с командой фронт и обновил UX - это очень упростило и улучшило пользовательский путь клиента и увеличило процент (около 25%) клиентов, которые в итоге доходили до конечной цели на сайте (совершение покупки).

-Запустил продукт на новых рынках (Казахстан и Аргентина): локализация, изучение юридических требований, платежи, организация поддержки и команды предоставляющей онлайн услуги на нужных языках.
