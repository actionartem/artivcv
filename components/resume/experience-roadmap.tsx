...
-Ведение полного цикла: сбор/уточнение требований, оценка, планирование, постановка задач, контроль исполнения, релиз.
-Управление кросс-функциональной командой 25+ человек: разработка, тестирование, аналитика, DevOps, СТП.
-Коммуникации с заказчиками: регулярные статусы, фиксация договоренностей, управление сроками и рисками.
-Подготовка технической, тендерной и проектно-сметной документации: СТ, ТЗ, API, архитектура, ПМИ, руководства, ЧТЗ, НМЦК, Паспорт проекта.

Результаты:

-Перестроил процесс релизов: перешли на 2ух недельные спринты и план-график релизов на 12 месяцев.
-Благодаря моим перестройкам в процессах разработки и релизов избавились от накопившегося тех-долга (800+ часов) без просадки по новым контрактам.
- Наладил флоу задач от получения требований, до вывода идею в ПРОД.
...
-Отвечаю за развитие B2B-продукта InOne: формирую видение, приоритеты и роадмап, согласую их с разработкой.
-Управляю бэклогом и приоритизацией: балансирую развитие и поддержку текущих проектов, держу фокус на том, что влияет на продажи и скорость внедрений.
-Участвую в пресейле и пилотах продукта, продумываю и прогоняю типовые сценарии для этого.`,
