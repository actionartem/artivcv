...
Я запускаю новые направления, нахожу партнёров и заключаю контракты, улучшаю продуктовые сценарии вместе с командой разработки и маркетингом, веду поддержку эксплуатации продукта в крупном гос-контуре.

Также внедряю GenAI-решения для оптимизации операционных процессов и аналитики: автоматизация обработки инцидентов и заведения тикетов, распознавание ошибок в данных, ускорение подготовки релизной документации и аналитических материалов.`
